...
train_pipeline = [
    ...
    dict(
        ...
        scales=[(1264, 1264), (1422, 1422), (1106, 1106), (948, 948),
                (1580, 1580), (1200, 1200)],
        keep_ratio=True),
...
test_pipeline = [
    dict(type='LoadImageFromFile', backend_args=None),
    dict(type='Resize', scale=(1264, 1264), keep_ratio=True),
    dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
    dict(
        type='PackDetInputs',
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='carla_instance_tfl_boxes_2-31.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        pipeline=[
            dict(type='LoadImageFromFile', backend_args=None),
            dict(type='Resize', scale=(948, 948), keep_ratio=True),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
            dict(
                type='PackDetInputs',
                meta_keys=('img_id', 'img_path', 'ori_shape', 'img_shape',
...
metainfo = dict(
    ...
    palette=[(10, 250, 10), (30, 255, 30), (255, 10, 0), (250, 250, 0),
             (10, 250, 0), (0, 10, 250), (250, 0, 0)])
launcher = 'pytorch'
work_dir = './work_dirs/mask-rcnn_r50-caffe_fpn_ms-poly-1x_carla_objects'
