...
data_root = '/home/luis/coco-annotator/datasets/emergency'
backend_args = None
train_pipeline = [
    ...
    dataset=dict(
        ...
        metainfo=dict(
            ...
            palette=[(10, 250, 10), (30, 255, 30), (255, 10, 0), (250, 250, 0),
                     (10, 250, 0), (0, 10, 250), (250, 0, 0), (250, 128, 0)])))
val_dataloader = dict(
    batch_size=1,
    num_workers=2,
    persistent_workers=True,
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file='/home/luis/coco-annotator/datasets/emergency/emergency-39.json',
    metric=['bbox', 'segm'],
    format_only=False,
    backend_args=None)
test_evaluator = dict(
...
metainfo = dict(
    classes=('bicycle', 'pedestrian', 'RedTrafficLight', 'YellowTrafficLight',
             'GreenTrafficLight', 'Vehicles', 'stop', 'emergency'),
    palette=[(10, 250, 10), (30, 255, 30), (255, 10, 0), (250, 250, 0),
             (10, 250, 0), (0, 10, 250), (250, 0, 0), (250, 128, 0)])
