...
"""autogenerated by genpy from msgs_action/VehicleState.msg. Do not edit."""
import codecs
import sys
...
class VehicleState(genpy.Message):
  _md5sum = "d59fbb8f50f426518dc752cfb6444965"
  _type = "msgs_action/VehicleState"
...
"""
  __slots__ = ['header','drive','engine_speed','throttle','car_gear','brake','handbrake']
  _slot_types = ['std_msgs/Header','ackermann_msgs/AckermannDrive','int32','float64','int32','int32','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,drive,engine_speed,throttle,car_gear,brake,handbrake
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_5fid3i().pack(_x.drive.steering_angle, _x.drive.steering_angle_velocity, _x.drive.speed, _x.drive.acceleration, _x.drive.jerk, _x.engine_speed, _x.throttle, _x.car_gear, _x.brake, _x.handbrake))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.drive.steering_angle, _x.drive.steering_angle_velocity, _x.drive.speed, _x.drive.acceleration, _x.drive.jerk, _x.engine_speed, _x.throttle, _x.car_gear, _x.brake, _x.handbrake,) = _get_struct_5fid3i().unpack(str[start:end])
      return self
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_5fid3i = None
def _get_struct_5fid3i():
    global _struct_5fid3i
    if _struct_5fid3i is None:
        _struct_5fid3i = struct.Struct("<5fid3i")
    return _struct_5fid3i
