...
"""autogenerated by genpy from msgs_traffic/TrafficSignArray.msg. Do not edit."""
import codecs
import sys
...
class TrafficSignArray(genpy.Message):
  _md5sum = "52473d5a9fb0a322cd148dfb905888a7"
  _type = "msgs_traffic/TrafficSignArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','msgs_traffic/TrafficSign[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.signs:
        ...
        _x = val1
        buff.write(_get_struct_dI().pack(_x.length, _x.road_id))
        length = len(val1.lanes)
        buff.write(_struct_I.pack(length))
        pattern = '<%sI'%length
        buff.write(struct.Struct(pattern).pack(*val1.lanes))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = msgs_traffic.msg.TrafficSign()
        start = end
        end += 1
        ...
        _v10 = val1.traffic_light
        start = end
        end += 1
        (_v10.color,) = _get_struct_B().unpack(str[start:end])
        _v11 = val1.pose
        _v12 = _v11.header
        start = end
        end += 4
        ...
        (_x.length, _x.road_id,) = _get_struct_dI().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sI'%length
        ...
        val1.lanes = s.unpack(str[start:end])
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.signs:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sI'%length
        buff.write(val1.lanes.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (val1.value,) = _get_struct_d().unpack(str[start:end])
        _v26 = val1.traffic_light
        start = end
        end += 1
        (_v26.color,) = _get_struct_B().unpack(str[start:end])
        _v27 = val1.pose
        _v28 = _v27.header
        start = end
        end += 4
        ...
        val1.lanes = numpy.frombuffer(str[start:end], dtype=numpy.uint32, count=length)
        self.signs.append(val1)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
