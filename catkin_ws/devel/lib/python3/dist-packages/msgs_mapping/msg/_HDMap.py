...
"""autogenerated by genpy from msgs_mapping/HDMap.msg. Do not edit."""
import codecs
import sys
...
class HDMap(genpy.Message):
  _md5sum = "f28f659f2e5da98f786a894149a1b462"
  _type = "msgs_mapping/HDMap"
...
float64 w
"""
  __slots__ = ['header','XML_HDMap','pose']
  _slot_types = ['std_msgs/Header','string','geometry_msgs/PoseWithCovarianceStamped']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.XML_HDMap = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.XML_HDMap = str[start:end]
      _x = self
      start = end
      end += 12
