...
(cl:defmethod cl:initialize-instance :after ((m <Brake>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Brake)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msgs_action-msg:<Brake> is deprecated: use msgs_action-msg:Brake instead.")))
...
(cl:defmethod value-val ((m <Brake>))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Brake>)))
  ...
  (cl:format cl:nil "Header header~%float64 value	# This represents how many percent will be applied in the brake system.~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Brake)))
  "Returns full string definition for message of type 'Brake"
  (cl:format cl:nil "Header header~%float64 value	# This represents how many percent will be applied in the brake system.~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
