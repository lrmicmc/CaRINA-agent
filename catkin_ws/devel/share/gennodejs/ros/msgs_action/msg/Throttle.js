...
class Throttle {
  ...
  static messageDefinition() {
    ...
    return `
    Header header
    float64 value	# This represents how many percent will be applied in the throttle.  
  ...
  static Resolve(msg) {
    ...
    const resolved = new Throttle(null);
