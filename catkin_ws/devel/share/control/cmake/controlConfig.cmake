...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/luis/carla/TRACK/team_code/catkin_ws/src/navigation/control)
  set(control_DEVEL_PREFIX /home/luis/carla/TRACK/team_code/catkin_ws/devel)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/luis/carla/TRACK/team_code/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'tiago <tiago@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/luis/carla/TRACK/team_code/catkin_ws/src/navigation/control/${idir}'.  ${_report}")
    endif()
