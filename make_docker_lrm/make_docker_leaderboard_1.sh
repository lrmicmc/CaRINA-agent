...
export CARLA_VERSION="0.9.10.1"
export CARLA_ROOT=/home/luis/carla/CARLA_$CARLA_VERSION/
export CARLA_SERVER=/home/luis/carla/CARLA_$CARLA_VERSION/CarlaUE4.sh
export LEADERBOARD_ROOT=/home/luis/carla/leaderboard
export TRACK_ROOT=/home/luis/carla/TRACK
export TEAM_CONFIG=""
export SCENARIO_RUNNER_ROOT=/home/luis/carla/scenario_runner
...
docker build --force-rm -t leaderboard-sensors -f ${TEAM_CODE_ROOT}/make_docker_lrm/Dockerfile_leaderboard.ros .
#docker build --force-rm -t leaderboard-map -f ${TEAM_CODE_ROOT}/make_docker_lrm/Dockerfile_leaderboard.ros .
rm -fr .tmp
